...
;(function(scriptGlobalObject, window, document, undefined){
  ...
  /**
   * Create our "modernizr.1e58e638" element that we do most feature tests on.
   *
   * @access private
   */
  var modElem = {
    elem: createElement('modernizr.1e58e638')
  };
  ...
  function testProps(props, prefixed, value, skipValueTest) {
    ...
    var elems = ['modernizr.1e58e638', 'tspan', 'samp'];
