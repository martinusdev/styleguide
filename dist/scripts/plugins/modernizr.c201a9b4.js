...
;(function(window, document, undefined){
  ...
  /**
   * Create our "modernizr.c201a9b4" element that we do most feature tests on.
   *
   * @access private
   */
  var modElem = {
    elem: createElement('modernizr.c201a9b4')
  };
  ...
  function testProps(props, prefixed, value, skipValueTest) {
    ...
    var elems = ['modernizr.c201a9b4', 'tspan', 'samp'];
