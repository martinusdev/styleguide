...
;(function(scriptGlobalObject, window, document, undefined){
  ...
  /**
   * Create our "modernizr.501058ff" element that we do most feature tests on.
   *
   * @access private
   */
  var modElem = {
    elem: createElement('modernizr.501058ff')
  };
  ...
  function testProps(props, prefixed, value, skipValueTest) {
    ...
    var elems = ['modernizr.501058ff', 'tspan', 'samp'];
