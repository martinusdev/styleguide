...
;(function(scriptGlobalObject, window, document, undefined){
  ...
  /**
   * Create our "modernizr.4a489747" element that we do most feature tests on.
   *
   * @access private
   */
  var modElem = {
    elem: createElement('modernizr.4a489747')
  };
  ...
  function testProps(props, prefixed, value, skipValueTest) {
    ...
    var elems = ['modernizr.4a489747', 'tspan', 'samp'];
